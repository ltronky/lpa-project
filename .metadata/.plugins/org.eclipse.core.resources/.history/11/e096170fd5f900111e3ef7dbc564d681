...
object CellGrid {
	def createCellsMatrix(rows:Int, columns:Int, previousWorld:Array[Array[Boolean]], init:Boolean, currentY:Int, currentX:Int):IndexedSeq[MyCell] = {
...
class CellGrid(override val rows:Int, override val columns:Int, val previousWorld:Array[Array[Boolean]], val init:Boolean) extends GridPanel(rows, columns) {
